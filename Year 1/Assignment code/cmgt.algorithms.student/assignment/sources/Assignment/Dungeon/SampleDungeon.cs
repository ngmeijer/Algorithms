...
class SampleDungeon : Dungeon
{
    ...
    protected override void generate(int pMinimumRoomSize)
    {
        ...
        finishedRooms.Add(new RoomContainer(new Rectangle(0, 0, size.Width / 2 + 1, size.Height)));
        //right room from half of screen to the end
        finishedRooms.Add(new RoomContainer(new Rectangle(size.Width / 2, 0, size.Width / 2, size.Height)));
